...
// Instantiates a new SQLite-backed NewsRepository
func NewNewsRepository(db *sql.DB) *NewsRepository {
	return &NewsRepository{db: db}
}

// Inserts a new news article into the database and updates its ID
...
// FindAll retrieves all news articles stored in the database
